...
export default function HeroHomeOne() {
  ...
  return (
    <>
      <section className="home-banner bg-yellow-400">
        <div className="container">
          ...
          <div className="banner_img">
            <div className="banner_img_inner moeffect">
              ...
              <div className="total_students_badge eitem" defaultValue="1" style={{ backgroundColor: '#FFD23F' }}>
                <div className="icon">
              ...
              <div className="total_course_badge align-self-center eitem" defaultValue="1.5" style={{ backgroundColor: '#FFD23F' }}>
                <div className="icon">
